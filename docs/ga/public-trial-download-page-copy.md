...
Turn everyday WhatsApp patrol photos into secure, organised and searchable site records.

`[DOWNLOAD FOR WINDOWS — DISABLED UNTIL PUBLIC-TRIAL AUTHORIZATION]`

**30-day free trial. No payment required to start.**

After the trial: **£299 plus VAT where applicable per Windows workstation per year.** Annual subscription; manual renewal.

## What PatrolSafe does

PatrolSafe helps security-company operations teams organize newly received JPEG and PNG patrol images from authorized WhatsApp groups. Create sites, map groups by display name, start monitoring and review evidence from one Windows workspace.

## How it works

1. Install the digitally signed Windows application.
2. Create your company workspace and review its time zone.
3. Link an authorized WhatsApp account.
4. Create sites and map approved groups.
...
- Windows 11 x64;
- Microsoft Edge, supported and updated;
- reliable outbound internet access to WhatsApp Web;
- an eligible authorized WhatsApp account with linked-device capability;
- a Windows account permitted to install desktop software;
...
`[DOWNLOAD SHA256SUMS.txt — NOT ENABLED]`

Do not install a file with a different hash or publisher. Do not disable Defender or SmartScreen to install PatrolSafe.
...
`[INSERT MANAGEMENT-APPROVED PUBLIC-TRIAL MARKET SCOPE BEFORE ENABLEMENT]`
...
Required live links before enablement:
...
### Do I need to pay before downloading?

No. No payment is required to download PatrolSafe or begin an eligible 30-day trial.
...
No. v1 renewal is manual and annual.
