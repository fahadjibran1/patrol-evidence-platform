...
Status: **TECHNICALLY COMPLETE — MANAGEMENT RISK ACCEPTED FOR CONTROLLED PILOT — FINAL-ARTIFACT RECONCILIATION REQUIRED**
...
| `THIRD_PARTY_NOTICES_DRAFT.txt` | `D19E44B1BDA98730B1DCD1DF71F656418A1FF4D36F5404002FBEB69CE19242B4` |
...
| Two LGPL findings | MANAGEMENT RISK ACCEPTED FOR CONTROLLED PILOT | Components/texts identified; external legal review not performed; management acceptance does not resolve obligations. |
...
|---|---:|---|---|---|
| `@img/sharp-win32-x64` | 0.35.4 | `Apache-2.0 AND LGPL-3.0-or-later` | Text collected | Legally unresolved; management risk accepted for controlled pilot |
| `node-webpmux` | 3.2.1 | `LGPL-3.0-or-later` | `COPYING.LESSER` collected | Legally unresolved; management risk accepted for controlled pilot |
| `argparse` | 2.0.1 | `Python-2.0` | Text collected | Legally unresolved; management risk accepted for controlled pilot |
...
The current unsigned-package inventory is **TECHNICALLY COMPLETE**. Vesoft management accepts the unresolved LGPL and special/compound interpretation risks for controlled B2B pilot distribution; external legal review was not performed. Release engineering must still rerun the inventory against the exact final signed pilot package, preserve the collected notices/texts and bind its hash to the final release association. This status does not approve unrestricted public GA.
