...
**External legal review has not been performed.** The inventory and texts are technically complete for the audited unsigned package; Vesoft management accepts the unresolved interpretation risk only for controlled B2B pilot distribution.
...
- draft notice bundle SHA-256: `D19E44B1BDA98730B1DCD1DF71F656418A1FF4D36F5404002FBEB69CE19242B4`.
...
Two LGPL-related packages and four special/compound expressions remain legally unresolved. Their directly available texts are collected. The engineering corrections removed a nested-example false positive, excluded an unnecessary generated Prisma payload from the desktop package, and deliberately marked the private internal `@patrol/license-core` package `UNLICENSED`. External legal review was not performed; management risk acceptance does not establish compliance.
