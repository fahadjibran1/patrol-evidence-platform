...
import { PatrolImageReconciliationService } from './patrol-image-reconciliation.service';
import { StorageModule } from '@/storage/storage.module';
import { SitesModule } from '@/sites/sites.module';

@Module({
  imports: [TypeOrmModule.forFeature([PatrolImage]), ComplianceModule, StorageModule, SitesModule],
  providers: [PatrolImagesService, PatrolImageIngestionService, PatrolImageSchemaService, PatrolImageReconciliationService],
